...
<body>
    ...
    <form method="post">
        ...
        <button type="submit" name="historico">Historico</button>
    ...
    if (isset ($_POST['calcular'])) {
        ...
        if ($num1 === '' || $num2 === '') {
            ...
            $_SESSION['salvar'] = prev($_SESSION['historico']);
        }
    }
    ...
    if (isset ($_POST['historico'])) {
        if (isset ($_SESSION['salvar'])) {
            echo "<p>Último valor armazenado na memória: {$_SESSION['salvar']}</p>";
        } else {
